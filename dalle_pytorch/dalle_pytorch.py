...
class DALLE_gpt_kakao(nn.Module):
    """
    Using kakao_gpt wte in the DALLE model
    """
...
class DALLE_gpt_trinity(nn.Module):
    def __init__(
        self,
        *,
        # dim,
        ...
        shift_tokens=True,
        rotary_emb=False,
        wte_dir="./ko_gpt_trinity_wte.pt",
        wpe_dir="./ko_gpt_trinity_wpe.pt",
    ):
        super().__init__()
        assert isinstance(
            vae, (DiscreteVAE, OpenAIDiscreteVAE, VQGanVAE)
